...
from model import db,Student,Interest,Notification,Counselor,CounselorSchedule,Feedback,Resource,Payment,Admin,Appointment,AdminLogActivity
...
def admins():
    return render_template('admin/admin_profile.html', active_page='admins')
